...
//```
d3.csv('incentives_2014_nozero.csv', function (data) {
  ...
  data.forEach(function (d) {
    ...
    // d.amount_possible = +d.amount_possible;
    d.amount_possible = +d.amount;
    d.amount = +d.amount;
  });
  ...
  dc.dataTable('.dc-data-table')
    ...
    .columns([
      ...
      'amount_possible',
      {
        ...
        format: function (d) {
          return numberFormat(d.amount / d.amount + 100);
        }
      },
      'uid',
      'gender',
